...
class _SJTagihDetailPageState extends State<SJTagihDetailPage> {
  ...
  /// ================= DETAIL VIEW (TIDAK DIUBAH UI-NYA) =================
  Widget _detailView() {
    return FutureBuilder<SjTagihModel>(
      future: futureData,
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return const Center(child: Text('Gagal mengambil detail SJ Tagih'));
        }
